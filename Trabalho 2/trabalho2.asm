...
faz_divisao:
	...
	la $a0, ($t4) #imprime valor final do número
	syscall	
    
    	
	beq $t4, $zero, se_par #se a quantidade de bits ligados for par, desvia para a rotina que atribui 0 para o bit de paridade
	bne $t4, $zero, se_impar #se a quantidade de bits ligados for ímpar, desvia para a rotina que deixa a paridade par
...
valida_entrada:    
	...
	beq $t3, $t0, se_invalido #desvia para rotina que faz o tratamento da entrada inválida
