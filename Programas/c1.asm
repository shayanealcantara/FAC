...
main:
	li $v0, 5 #lê o primeiro número inteiro a partir do terminal
	syscall 
...
_srl:   #realiza deslocamento de 1 bit à esquerda do segundo número(shift right logical)
  	li $v0, 4 #lê string, armazena em $v0
	la $a0, $srl  #imprime "\nSRL: "
	syscall # faz a syscall
