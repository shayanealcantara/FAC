...
tabela_ascii: .word 48, 49, 50, 51, 52, 53, 54, 55, 56, 58, 65, 66, 67, 68, 69, 70
...
loop:
	...
	beq $a0, 10, imprime_crc		# Se $a0 for igual a 10, é porque a string terminou
...
imprime_crc:
	...
	li $v0, 11
	la $a0, ($t7) 			#print pra testar $t4(s)
	syscall
	
	la $t8, tabela_ascii
	and $t6, $t2, 0x0f00 		# t6 = r & 0xf000
	srl $t6, $t6, 8			# t6 = t6 >> 12 # 3*4
	mul $t6, $t6, 4
	add $t8, $t8, $t6
	lw $t7, 0($t8)
